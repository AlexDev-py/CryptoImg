...
if __name__ == '__main__':
    if input('(encrypt or decrypt) e or d: ') == 'e':
        ...
        crypto_img = encrypt(text_to_encrypt, private_key, BytesIO(img_data))
        ...
        print(decrypt(private_key, BytesIO(img_data)))
